...
<ul>
	<li>
		...
		<details>
    <summary>Abstract</summary>
Civil service systems promise equal access to government employment, yet the bureaucracies
they govern often remain unrepresentative: US police departments are
systematically Whiter and more Republican than their jurisdictions. Scholarship and
police reforms have focused on written entry exams, but bureaucratic careers extend
well beyond entry. Drawing on novel data linking exam, career, and voter records for
99,000 exam passers and 58,000 NYPD officers, this study decomposes these disparities
across the career pipeline. The application and written exam produce limited sorting.
Instead, even among applicants with comparable exam scores, post-exam hiring favors
Republican and White candidates, who are more likely to be promoted, receive awards,
and remain in the agency. Equalizing post-exam hiring alone would increase appointments
of Democratic and Black candidates by 78% and 27%. These findings redirect
attention from the entry exam to the discretionary procedures that follow, and reveal
how formally meritocratic institutions sustain unequal representation. </details>
		<a href="https://elisawirsching.github.io/research/limitsofmerit.pdf"><div class="color-button">pdf</div></a>
	</li><br>
...
electoral outcomes, yet we lack systematic evidence on how this bureaucratic resistance
moves reform attitudes among voters and elected officials. We argue that police
wield two tools grounded in their day-to-day service provision: fearmongering, public
warnings that tie a reform to future service decline, and resistance shirking, the quiet
withdrawal of effort afterward. Because voters cannot easily distinguish policy failure
from bureaucratic resistance, the mere prospect of pushback can deter voter and
policymaker support for reform. We test this with two survey experiments, alongside
observational evidence on the prevalence of police fearmongering and slowdowns. A
2×2 vignette experiment with 1,676 mass-public respondents varies whether a police
union signals cooperation or fearmongering and whether post-reform service quality
improves or worsens, and an experiment of more than 500 sitting local elected officials
varies whether police threaten resistance to a qualified-immunity reform. In the mass
experiment, fearmongering is independently costly to politicians regardless of service
outcomes, and service quality strongly shapes support for both reforms and incumbents.
In the elite experiment, a threatening police response substantially reduces
officials’ support for reform even though no service decline has occurred. Together,
these results show that police possess strategic tools operating across the entire policy
pipeline, creating anticipatory political costs for both voters and policymakers. </details>
		<a href="https://elisawirsching.github.io/research/krishnamurthy_wirsching_yogev_police_slowdowns.pdf"><div class="color-button">pdf</div></a>
	</li><br>
	
	<li>
		<b>Cultural Conflicts, Professional Identity, and Workforce Sorting: Evidence from U.S. Public School Employees</b><br>
...
<ul>
	<li>
		<b>Identity Politics and Teacher Selection: How Cultural Conflicts and Restrictions Influence US Teachers</b><br>
		<i>with <a href="https://roxannerahnama.com/">Roxanne Rahnama</a> and <a href="https://tylersimko.com/">Tyler Simko</a></i><br>
	</li><br>
